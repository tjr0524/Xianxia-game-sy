...
const inputs=['game_v11.js','ink_runtime_v11_31.js','ink_assets_v11_31.css'];
...
if(process.argv.includes('--check')){
  const tokens=[...html.matchAll(/(?:game_v11\.js|ink_(?:assets_v11_31\.css|runtime_v11_31\.js))\?v=([^"']+)/g)].map(m=>m[1]);
  if(tokens.length!==3||tokens.some(value=>value!==token)){
