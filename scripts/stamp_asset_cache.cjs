...
const inputs=['game_v11.js','ink_runtime_v11_31.js','ink_assets_v11_31.css','visual_v11_25.js'];
...
if(process.argv.includes('--check')){
  const tokens=[...html.matchAll(/(?:game_v11\.js|visual_v11_25\.js|ink_(?:assets_v11_31\.css|runtime_v11_31\.js))\?v=([^"']+)/g)].map(m=>m[1]);
  if(tokens.length!==4||tokens.some(value=>value!==token)){
