...
if(!index.includes('BUILD 11.48.0'))throw new Error('test build label is not 11.48.0');
if(!kernel.includes("const BUILD='11.48.0'"))throw new Error('canonical test build is not 11.48.0');
const flat=[
