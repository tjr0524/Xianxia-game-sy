...
if(!index.includes('BUILD 11.49.3'))throw new Error('test build label is not 11.49.3');
if(!kernel.includes("const BUILD='11.49.3'"))throw new Error('canonical test build is not 11.49.3');
const flat=[
