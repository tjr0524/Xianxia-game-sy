...
const AREA_UNLOCKS={blackwind:{s:200,h:8,hg:0,req:{major:0,stage:3},prereq:[['qingyun','eco2',3]],label:'흑풍곡 개방'},blood:{s:400,h:10,hg:1,req:{major:0,stage:6},prereq:[['blackwind','eco2',3],['blackwind','fate2',3]],label:'적혈비경 개방'},foundation_trial:{s:0,h:0,hg:0,req:{major:0,stage:9},prereq:[],label:'축기 시련 도전'},thunder:{s:0,h:0,hg:2,req:{major:1,stage:1},prereq:[],insight:1,label:'천뢰봉 개방'},marsh:{s:0,h:0,hg:2,req:{major:1,stage:4},prereq:[],label:'자운택 개방'},taixu:{s:0,h:0,hg:2,req:{major:1,stage:7},prereq:[],label:'태허유적 개방'},jiedan_trial:{s:0,h:0,hg:2,req:{major:1,stage:9},prereq:[],label:'결단 시련 도전'}};
...
taixu:{root:{x:1539,y:644},branches:{eco:[{x:1440,y:731},{x:1386,y:752},{x:1312,y:794}],fate:[{x:1453,y:678},{x:1396,y:668},{x:1342,y:656}],res:[{x:1619,y:670},{x:1659,y:636},{x:1681,y:586}],formation:[{x:1631,y:716},{x:1675,y:743},{x:1727,y:772}]},gate:{jiedan_trial:{x:1792,y:606}}},
jiedan_trial:{root:{x:1900,y:548},branches:{},gate:{}}
};
