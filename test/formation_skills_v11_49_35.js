...
sword:[
 {req:{major:0,stage:2},o:[
  ...
  ['pierce','관통검','첫 대상 100% · 뒤로 220 world 관통 · 추가 2체 85%']]},
...
shield:[
 ...
 {req:{major:2,stage:1},o:[
  ['renew','귀원갑','호체 1층 파괴 시 이미 재생 중인 다른 층 재생시간 1.5초 당김 · 공격 1회당 1회'],
  ['glide','유광신법','호체 파괴 시 이동속도 +35% / 2.5초 · 축지 충전 회복 1.0초 진행'],
  ['mana','만법환류','호체 파괴 시 가장 긴 자동법술 남은 CD 25% 감소 · 나머지 8% 감소 · 공격 1회당 1회']]}
],
dash:[
 {req:{major:1,stage:3},o:[
...
burst:[
 ...
 {req:{major:2,stage:1},o:[
  ['trueburst','극진폭발','폭주 지속 -30% · 폭주 시작 후 첫 1.5초 CD 진행배율 ×1.6 추가'],
  ['greatcycle','대주천','폭주 지속 +35% · 폭주 CD -20% · 기본 CD 진행배율 -15%'],
  ['warvein','전투광맥','특수몹 처치 시 지속 +0.5초 · 일반몹 처치 20% 확률 +0.25초 · 1회 폭주 최대 +4초']]}
]
};
