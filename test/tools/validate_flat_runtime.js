...
if(!index.includes('BUILD 11.47.1'))throw new Error('test build label is not 11.47.1');
if(!kernel.includes("const BUILD='11.47.1'"))throw new Error('canonical test build is not 11.47.1');
const flat=[
