...
function installHandle(){
  ...
  const end=e=>{if(!drag)return;drag=false;b.classList.remove('dragging');b.style.transform='translateX(-50%)';if(dy>34)closePanel();try{b.releasePointerCapture(e.pointerId)}catch{}e.preventDefault();e.stopPropagation();};
